...
$currencyNames = [
	...
	'SLL' => 'sierro-leonský leone (1964—2022)',
	'SOS' => 'somálský šilink',
...
$timeUnits = [
	'century-few' => '{0} stoletích',
	'century-many' => '{0} století',
	'century-one' => '{0} století',
	'century-other' => '{0} stoletích',
	'day-few' => '{0} dnech',
	...
	'day-person-few' => '{0} dny',
	'day-person-many' => '{0} dne',
	'day-person-one' => '{0} dnem',
	'day-person-other' => '{0} dny',
	'decade-few' => '{0} desetiletích',
	'decade-many' => '{0} desetiletí',
	'decade-one' => '{0} desetiletí',
	'decade-other' => '{0} desetiletích',
	...
	'microsecond-few' => '{0} mikrosekundách',
	'microsecond-many' => '{0} mikrosekundy',
	'microsecond-one' => '{0} mikrosekundě',
	'microsecond-other' => '{0} mikrosekundách',
	'millisecond-few' => '{0} milisekundách',
	'millisecond-many' => '{0} milisekundy',
	'millisecond-one' => '{0} milisekundě',
	'millisecond-other' => '{0} milisekundách',
	'minute-few' => '{0} minutách',
	...
	'nanosecond-few' => '{0} nanosekundách',
	'nanosecond-many' => '{0} nanosekundy',
	'nanosecond-one' => '{0} nanosekundě',
	'nanosecond-other' => '{0} nanosekundách',
	'quarter-few' => '{0} čtvrtletích',
	...
	'quarter-many' => '{0} čtvrtletí',
	'quarter-one' => '{0} čtvrtletí',
	'quarter-other' => '{0} čtvrtletích',
	...
	'second-one' => '{0} sekundě',
	'second-other' => '{0} sekundách',
